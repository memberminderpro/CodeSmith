public string InputSize(ColumnSchema column)  
{
string strRet;
    ...
    switch (strType)
		{
			...
			case "nvarchar":
                if (nSize < 0) {
				    strRet = "cols=\"60\" rows=\"3\"";
				    return strRet;
                } else if ( nSize > 80 ){
    				strRet = "size=\"80\" maxlength=\""+nSize+"\"";
				    return strRet;
                } else {
				strRet = "size=\""+nSize+"\" maxlength=\""+nSize+"\"";
				    return strRet;
